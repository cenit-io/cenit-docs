...
| Algorithm for Contact  | do_start_converters                                                                                                                                                                                                        | The algorithm used by the [Recipes](connector_factory/recipes.md) to find the existing algorithms for mapping a Contact record to records of other Data Types |
| Algorithm for Lead     | do_start_converters                                                                                                                                                                                                        | The algorithm used by the [Recipes](connector_factory/recipes.md) to find the existing algorithms for mapping a Lead record to records of other Data Types    |
