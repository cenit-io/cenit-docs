  ...
  tutorialSidebar: [
     {
      type: 'category',
      label: 'Tutorials',
      items: ['tutorials/basic_integration'],
    }, 
    {
      type: 'category',
    ...
    },
	{
      type: 'category',
      label: 'Security',
      items: ['security/security', 'security/authorization_concepts', 'security/authorization', 'security/authorization_definition', 'security/authorization_clients', 'security/authorization_providers'],
    },
	{
      type: 'category',
      label: 'Gateway',
